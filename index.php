...
$pagesArray = array();				
				...
				switch($action){
					...
					case 'favorites':
						...
						$pages = ceil($numberOfItem/$articlePerPages); 
						$startArticle = ($page-1)*$articlePerPages;
						$events = $eventManager->loadAllOnlyColumn($target,array('favorite'=>1),'pubDate ASC',$startArticle.','.$articlePerPages);
					...
					default:
						...
						$pages = ceil($numberOfItem/$articlePerPages); 
						$startArticle = ($page-1)*$articlePerPages;
						$events = $eventManager->loadAllOnlyColumn($target,array('unread'=>1),'pubDate ASC',$startArticle.','.$articlePerPages);
						$tpl->assign('numberOfItem',$numberOfItem);
						$tpl->assign('pages',$pages);
						$tpl->assign('page',$page);
